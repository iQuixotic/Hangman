...
function checkStatus () {
    ...
    // if( brokenWord[brokenWord.length] !== "_ " + " " && [brokenWord.length] !== "__" + " "  && [brokenWord.length + 1 ] !== "__" + " " &&
    // [brokenWord.length + 2 ] !== "__" && [brokenWord.length + 3 ] !== "__" && [brokenWord.length + 4 ] !== "__" && [brokenWord.length + 5 ] !== "__"){
    //     wins++;
